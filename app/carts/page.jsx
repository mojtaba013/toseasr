...
function Post() {
  return (
    <>
      <div className=" w-full flex fixed top-0 right-0 left-0 bg-white py-6 px-4 items-center justify-between">
        <Link href="/">
          <svg
      ...
      <div className="bg-gray-100 flex flex-col items- h-full p-6 gap-y-4   ">
