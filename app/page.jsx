...
export default function Home() {
  return (
    // mobile mode
    <div className="sm:hidden h-[100vh]   bg-gray-200">
      <header className="bg-white h-12 flex justify-between items-center">
        <div className="pr-2">
          <svg
        ...
        <div className="text-slate-800">قرض الحسنه توسعه عصر</div>
        <div className="pl-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
      ...
      <div className=" flex flex-col mx-2 mt-3  rounded-md  bg-white text-right  ">
        <h1 className="text-slate-800 pt-4 pr-4 pb-4">خدمات پرکاربرد</h1>
        <div className="flex flex-row flex-wrap gap-6 flex-1   px-6 pb-6">
          ...
          <div className="flex flex-col items-center text-slate-800">
            ...
            <p className="text-xs font-medium">شارژ</p>
          </div>
          <div className="flex flex-col items-center text-slate-800">
            <div className="flex items-center justify-center  w-16 h-16 bg-gray-100 rounded-md">
              <svg
            ...
            <p className="text-xs font-medium">قبض</p>
          </div>
          <div className="flex flex-col items-center text-slate-800">
            <div className="flex items-center justify-center  w-16 h-16 bg-gray-100 rounded-md">
              <svg
            ...
            <p className="text-xs font-medium">تسهیلات</p>
          </div>
          <div className="flex flex-col items-center text-slate-800">
            <div className="flex items-center justify-center  w-16 h-16 bg-gray-100 rounded-md">
              <svg
            ...
            <p className="text-xs font-medium">بسته اینترنتی</p>
          </div>
          <div className="flex flex-col items-center text-slate-800">
            <div className="flex items-center justify-center  w-16 h-16 bg-gray-100 rounded-md">
              <svg
